...
module.exports = function(homebridge){
  ...
  homebridge.registerAccessory("homebridge-httpgaragedoor", "HttpGarageDoor", HttpGarageDoorAccessory);
}
...
HttpGarageDoorAccessory.prototype.doorToggle = function(targetState, callback) {
    this.doorStatus(function(err, currentState) {
        if (currentState != targetState) {
            // toggle the http garage door state
            request.post({
...
HttpGarageDoorAccessory.prototype.doorStatus = function(callback) {
    // get the state from the http garage door
    request.get({
